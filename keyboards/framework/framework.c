...
#    if defined(CAPS_LOCK_LED_INDEX) || defined(NUM_LOCK_LED_INDEX)
...
#   if defined(CAPS_LOCK_CUSTOM_LED_R) && defined(CAPS_LOCK_CUSTOM_LED_G) && defined(CAPS_LOCK_CUSTOM_LED_B)
    ...
    RGB_MATRIX_INDICATOR_SET_COLOR(CAPS_LOCK_LED_INDEX,
		scale8(CAPS_LOCK_CUSTOM_LED_R, val),
		scale8(CAPS_LOCK_CUSTOM_LED_G, val),
		scale8(CAPS_LOCK_CUSTOM_LED_B, val));
#   else
    RGB_MATRIX_INDICATOR_SET_COLOR(CAPS_LOCK_LED_INDEX, val, val, val);
#   endif
  } else {
...
#   if defined(NUM_LOCK_CUSTOM_LED_R) && defined(NUM_LOCK_CUSTOM_LED_G) && defined(NUM_LOCK_CUSTOM_LED_B)
    RGB_MATRIX_INDICATOR_SET_COLOR(NUM_LOCK_LED_INDEX,
		scale8(NUM_LOCK_CUSTOM_LED_R, val),
		scale8(NUM_LOCK_CUSTOM_LED_G, val),
		scale8(NUM_LOCK_CUSTOM_LED_B, val));
#   else
    RGB_MATRIX_INDICATOR_SET_COLOR(NUM_LOCK_LED_INDEX, val, val, val);
#   endif
  } else {
    if (!rgb_matrix_get_flags()) {
