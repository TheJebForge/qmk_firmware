...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, SWITCH_COLORED, SWITCH_REACTIVE, SWITCH_SOLID, BL_STEP, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_SPI, RGB_VAI, _______, _______, KC_PAUS, _______, _______, _______,
        _______, _______, KC_SYRQ, RGB_RMOD,RGB_HUD, RGB_SAD, RGB_SPD, RGB_VAD, KC_SCRL, _______, _______, _______,          QK_CLEAR_EEPROM,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case FN_LOCK:
            ...
            break;
        case SWITCH_COLORED:
            rgb_matrix_mode(RGB_MATRIX_CUSTOM_multicolor_map);
            break;
        case SWITCH_REACTIVE:
            rgb_matrix_mode(RGB_MATRIX_CUSTOM_WIDE_REACTIVE_BACKLIGHT);
            break;
        case SWITCH_SOLID:
